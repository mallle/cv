<template>
  <section class="cv-section">
    ...
    <br />
    <p>
      Malene Klit <br />Weißsenseestr. 25a <br />81539 München <br />Deutschland
      <br />E-Mail (bevorzugt): maleneklit@hotmail.com <br />Telefon:
      01624201615
    </p>
    <br />
    ...
    <p>
      ...
      Darüber hinaus erhalten Sie Informationen und Anleitungen, wie diese
      Cookies gelöscht oder deren Speicherung vorab blockiert werden können. Je
      nach Anbieter Ihres Browsers finden Sie die notwendigen Informationen
    ...
    <p>
      Malene Klit <br />Weißsenseestr 25a <br />
      81539 München
    </p>
    <hr />
    <br />
...
<style scoped>
h2 {
  @apply text-xl md:text-3xl font-bold mt-12;
}
</style>
